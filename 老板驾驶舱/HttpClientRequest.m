...
+(HttpClientRequest*)sharedInstance
{
    if (_sharedHttpClient == nil) {
        ...
        dispatch_once(&onceToken, ^{
            ...
            // 221.228.197.77:8010 zhengshi  222.191.251.180:8010
            _sharedHttpClient = [[HttpClientRequest alloc]initWithBaseURL:[NSURL URLWithString:@"http://221.228.197.77:8010/MerchantCenterApple/"]];
        });
    }
