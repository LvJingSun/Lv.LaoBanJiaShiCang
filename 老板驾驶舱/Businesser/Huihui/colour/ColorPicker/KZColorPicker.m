...
//    [defaults setObject:[NSString stringWithFormat:@"%d",r1]  forKey:@"reed"];
//    [defaults setObject:[NSString stringWithFormat:@"%d",g1]  forKey:@"green"];
//    [defaults setObject:[NSString stringWithFormat:@"%d",b1]  forKey:@"blue"];
...
//    NSUserDefaults *defaults = [NSUserDefaults standardUserDefaults];
//    [defaults setObject:[NSString stringWithFormat:@"%f",self.alphaSlider.value]  forKey:@"alpha"];
