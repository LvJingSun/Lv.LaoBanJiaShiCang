...
@implementation AddSupplierView
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        nameField.placeholder = @"请输入供应商姓名";
        ...
        titleField.placeholder = @"请输入供应商门店信息";
        ...
        telField.placeholder = @"请输入供应商联系电话";
...
//    }
//    
//    if ([self.telField isExclusiveTouch]) {
//        
//        [self.telField resignFirstResponder];
//        
//    }
//    
//    if ([self.genderField isExclusiveTouch]) {
//        
