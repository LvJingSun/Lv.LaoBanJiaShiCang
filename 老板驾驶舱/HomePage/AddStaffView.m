...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        titleField.placeholder = @"请选择员工职位";
        
        self.titleField = titleField;
        
        [self addSubview:titleField];
        
        UIButton *titleBtn = [[UIButton alloc] initWithFrame:CGRectMake(nameFieldX, CGRectGetMaxY(line2.frame) + 5, nameFieldW, nameFieldH)];
        ...
        telField.placeholder = @"请输入员工联系电话";
        ...
        genderField.placeholder = @"请选择员工性别";
