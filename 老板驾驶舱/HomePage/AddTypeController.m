...
@interface AddTypeController ()<UITableViewDelegate,UITableViewDataSource> {
...
@implementation AddTypeController
...
- (void)requestSaveData {
    ...
    [httpClient request:@"ErpFenLeiAdd.ashx" parameters:paeameters success:^(NSJSONSerialization* json){
        ...
        if ([dic[@"msg"] isEqualToString:@"添加成功"]) {
            
            [self.navigationController popViewControllerAnimated:YES];
            
            NSLog(@"%@",((NSDictionary *)json)[@"msg"]);
