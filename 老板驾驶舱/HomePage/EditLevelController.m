...
@interface EditLevelController ()<UITableViewDelegate,UITableViewDataSource> {
...
@implementation EditLevelController
...
- (void)viewDidLoad {
    ...
    yongJinLevelID = self.yongJinLevelID;
...
- (void)saveBtnClick {
    ...
    if ([self.textField.text isEqualToString:@""]) {
        ...
        if ([mingCheng isEqualToString:self.mingCheng]) {
